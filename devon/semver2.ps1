# param (
#     [string]$specMatch = '',
#     [string]$specsString = 'x',
#     [string]$specsFile = '',
#     [string]$outputFormat = 'cmd',
#     [string]$output = '',
#     [switch]$bestMatch = $false
# )

$specMatch = $env:specMatch
$specsString = $env:specsString
$specsFile = $env:specsFile
$outputFormat = $env:outputFormat
$output = $env:output
$bestMatch = $env:bestMatch


$comment = 'app[=ver][@arch][patches] app=...'
$comment = 'app1=3.1.X@x86 app2=3.1.X@x86'
$comment = 'myname@app1:3.1.X_x86 app2:3.1.X_x64[.]'
...
if ($outputFormat -eq 'cmd') {
    $formatter = ${function:FormatSpecForCmd}
}
